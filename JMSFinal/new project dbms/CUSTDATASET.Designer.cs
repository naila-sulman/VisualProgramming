...
namespace new_project_dbms.CUSTDATASETTableAdapters {
...
SELECT CUSTOMERID, NAME, CONTACTNUMBER, ADDRESS, NIC, JOINDATE, STATUS, LEAVEDATE FROM CUSTOMER WHERE (CUSTOMERID = @CUSTOMERID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT CUSTOMERID, NAME, CONTACTNUMBER, ADDRESS, NIC, JOINDATE, STATUS, LEAVEDATE" +
                " FROM dbo.CUSTOMER";
        ...
        public virtual int FillBy(CUSTDATASET.CUSTOMERDataTable dataTable) {

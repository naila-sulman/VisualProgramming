...
namespace new_project_dbms.DataSet1TableAdapters {
...
SELECT PRODUCTID, PRODUCTNAME, INSTRUCTION, FORMULA, QUANTITYINSTOCK, PACKINGID, BATCHID, TRADEMARKID, RETAILPRICE, TRADEPRICE, MARKUP, EXPIRYDATE, MANUFACTUREDATE FROM PRODUCT WHERE (PRODUCTID = @PRODUCTID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        PRODUCTID, PRODUCTNAME, INSTRUCTION, FORMULA, QUANTITYINSTOCK, PACKINGID, BATCHID, TRADEMARKID, RETAILPRICE, TRADEPRICE, MARKUP, 
                         EXPIRYDATE, MANUFACTUREDATE
FROM            PRODUCT
WHERE        ((SELECT        DATEDIFF(day, PRODUCT.EXPIRYDATE, @inpdate) AS DiffDate) < 65)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@inpdate", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(DataSet1.PRODUCTDataTable dataTable, System.DateTime inpdate) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((System.DateTime)(inpdate));
        ...
        public virtual DataSet1.PRODUCTDataTable GetData(System.DateTime inpdate) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((System.DateTime)(inpdate));
